    ...
    return (
      <div className="flex justify-center">
        <article className="break-normal px-6 md:px-0 my-10 prose md:prose-xl dark:prose-dark dark:md:prose-xl-dark">
          <h1>Sobre somos</h1>
          <p>
            Antes de presentarnos queremos que nos acompañes a través de un recorrido por diferentes lugares. Todos los datos que encontrarás en nustro blog son reales y desde la mirada de quien les narra. Te invitmos sin embargo a verificar la información ya que siempre cabe una actualización. Entenderás entonces, que algunos relatos estarán corriendo a contrarreloj, y otros servirán como tips generales para que te prepares a vivir la experiencia.
          </p>
          <p>
            Como se trata de nuestras experiencias, no incluimos datos de tours o de hoteles 5 estrellas, no es el relato del turista que pagó con mucha anticipación hasta el mínimo detalle. Somos personas que trabajamos, ahorramos y si podemos, viajamos. Definimos el destino durante el viaje y vamos adaptándonos a las condiciones. Nos gusta caminar, conocer mucha gente, probar cualquier clase de comida y bebida que sea tradicional, típica o popular, aprender con free tours, visitar museos y sitios turísticos, también lugares cotidianos para conocer su historia y comprender su forma de vida, y por supuesto caminar más, siempre a nuestro ritmo.
          </p>
          <p>
